...
HRESULT InitialObject()
{
   CUSTOMVERTEX Vershin[] =
    {          // синий
       ...
       {  1.0f, 1.0f, -1.0f, 0x00000fff, }, //В
       { -1.0f, 1.0f, -1.0f, 0x00000fff, }, //С
	   { -1.0f,-1.0f, -1.0f, 0x00000fff, }, //D
               // красный
       { -1.0f,-1.0f, -1.0f, 0xffff0000, }, //A2
       { -1.0f, 1.0f, -1.0f, 0xffff0000, }, //B2
       { -1.0f, 1.0f,  1.0f, 0xffff0000, }, //C2
	   ...
	   {  1.0f,-1.0f,  1.0f, 0x00000fff, }, //D3
               // зеленый
       {  1.0f,-1.0f,  1.0f, 0xff0fff00, }, //A4
       {  1.0f, 1.0f,  1.0f, 0xff0fff00, }, //B4
       {  1.0f, 1.0f, -1.0f, 0xff0fff00, }, //C4
	   {  1.0f,-1.0f, -1.0f, 0xff0fff00, }, //D4
               // розовый
       {  1.0f,-1.0f, -1.0f, 0xfff000ff, }, //A5
       { -1.0f,-1.0f, -1.0f, 0xfff000ff, }, //B5
       { -1.0f,-1.0f,  1.0f, 0xfff000ff, }, //C5
	   {  1.0f,-1.0f,  1.0f, 0xfff000ff, }, //D5
               // розовый
       {  1.0f, 1.0f,  1.0f, 0xfff000ff, }, //A6
       { -1.0f, 1.0f,  1.0f, 0xfff000ff, }, //B6
       { -1.0f, 1.0f, -1.0f, 0xfff000ff, }, //C6
	   {  1.0f, 1.0f, -1.0f, 0xfff000ff, }, //D6
